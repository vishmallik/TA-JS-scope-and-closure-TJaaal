...
//function multiplyArrayByN is a higher order function and function addFive and multiplyBy5 are callback functions.
...
console.log(
  operation("Higher Order Function", function (text) {
    return text.split(" ");
  })
);
